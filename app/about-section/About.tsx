      ...
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-medium  leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
            ...
            <AnimatedBody
              text={
                "Beyond coding, I write articles for blogs and tech commninities such as Griddb Developer Community and Symbl.ai where I actively mentor tech enthisiasts."
              }
              className={"hidden"}
            />
            <AnimatedBody
            ...
            <AnimatedBody
              text={
                "Outside of work, I love traveling, reading books, cheering on Manchester United, and discovering new music in genres like RnB, Trap, and Chill Rap. I'm currently working on some exciting projects that I can't wait to share with you. But I’m always open to new opportunities and collaborations."
              }
            />
          </div>
          ...
          <div className="mb-24 flex w-[100%] flex-col gap-4 text-[18px] font-normal leading-relaxed tracking-wide text-[#e4ded7]/80 sm:mb-32 md:mb-40 md:gap-6 md:text-[16px] md:leading-normal lg:mt-0 lg:mb-16 lg:max-w-[30%] lg:text-[18px]">
            ...
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimatedBody
                text={
                  "Python, Flask, SQL, Apache Spark, Docker, Apache Kafka, AWS, GCP, Microsoft Azure, Linux, RabbitMQ, Apache Flink, Hadoop."
                }
              />
            </div>
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimatedBody
                text={
                  "MongoDB, PostgreSQL, Cassandra, Snowflake and MySQL."
                }
              />
            </div>
